...
public class Constants {
    ...
    public static final String EMERGENCY_NUMBER = "100";

    public static final String SHARED_PREFERENCES_KEY = "MyPrefs";
    public static final String ORIGIN_LATITUDE = "origin_latitude";
    public static final String ORIGIN_LONGITUDE = "origin_longitude";
    public static final String BOUNDARY_LIMIT = "boundary_limit";
    public static final String BOUNDARY_CROSSED = "boundary_crossed";
    public static final String BOUNDARY_ENTERED = "boundary_entered";
}
