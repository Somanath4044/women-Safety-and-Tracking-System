...
import com.pemchip.womensafty.databinding.FragmentHomeBinding;
import com.pemchip.womensafty.service.SosService;
import com.pemchip.womensafty.ui.activity.LoginRegisterActivity;
import com.pemchip.womensafty.ui.activity.MainActivity;
import com.pemchip.womensafty.util.AppUtil;
import com.pemchip.womensafty.util.FirebaseUtil;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.about.setOnClickListener(v -> Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_settingsFragment));
